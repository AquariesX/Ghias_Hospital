        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-300 mt-0.5">
                Hospital Patient Number is permanently generated by the system. The MR Number can be manually adjusted below if needed.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="bg-white/10 px-3.5 py-1.5 rounded-lg border border-white/10">
              <span className="text-[10px] text-slate-400 block">SYSTEM PATIENT NUMBER</span>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {/* MR Number (Manual) */}
            <div className="sm:col-span-2 lg:col-span-3 bg-teal-50/50 p-4 rounded-xl border border-teal-200/80">
              <label className="block text-xs font-bold text-teal-950 mb-1">
                Medical Record (M.R.) Number <span className="text-rose-500">*</span>
              </label>
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                <input
                  ...
                  placeholder="e.g., MR-001234 or Physical Chart ID"
                  required
                  className="w-full sm:max-w-md px-3.5 py-2 text-sm text-black font-mono font-bold bg-white rounded-lg border border-teal-300 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
                />
                <span className="text-xs text-teal-700">
                  Manually assigned chart/hospital folder number. Must be unique across all patients.
                </span>
              </div>
